 ...
 * 
 * @version		$Id: class.ilObjQuestionPoolGUI.php 60741 2015-09-17 08:53:32Z bheyser $
 *
	...
	private function buildQuestionBrowserTableGUI($taxIds)
	{
		...
		if( $this->object->isNavTaxonomyActive() && (int)$_GET['tax_node'] )
		{
			$questionList->addTaxonomyFilter(
				$this->object->getNavTaxonomyId(), array((int)$_GET['tax_node']), $this->object->getId(), 'qpl'
			);
		}
