 ...
 * @version		$Id: class.ilObjTest.php 57112 2015-01-14 12:04:41Z bheyser $
 *
...
*/
	function getAvailableQuestions($arrFilter, $completeonly = 0)
	{
		...
		include_once "./Modules/TestQuestionPool/classes/class.ilObjQuestionPool.php";
		$available_pools = array_keys(ilObjQuestionPool::_getAvailableQuestionpools(
			$use_object_id = TRUE, $equal_points = FALSE, $could_be_offline = FALSE, $showPath = FALSE, $with_questioncount = FALSE
		));
		$available = "";
		if (count($available_pools))
		{
